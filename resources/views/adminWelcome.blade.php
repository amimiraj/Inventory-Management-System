        ...
        <div id="header" class="navbar navbar-inverse navbar-fixed-top">
            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <!-- END  NOTIFICATION -->
                    <div class="top-nav " >
                        <ul class="nav pull-right top-menu extended" >
                ...
                <div id="sidebar" class="nav-collapse collapse">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a class="" href="{{url('/addAccount')}}">Add Account</a></li>
                                <li><a class="" href="{{url('/manageAccount')}}">Manage Account</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a class="" href="{{url('/adminStock')}}">View Stock</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a class="" href="{{url('/adminReport')}}">Daily Sale Report</a></li>
                            </ul>
                        </li>
